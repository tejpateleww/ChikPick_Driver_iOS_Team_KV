...
//        let user = Singleton.shared.userProfile//Singleton.shared.bookingInfo

//        let base = NetworkEnvironment.imageURL

//        imgProfilePick.sd_setImage(with: URL(string: base + (user?.responseObject.profileImage)! ), completed: nil)
//        
...
//        let profileData = Singleton.shared.dictProfile
//
...
//        btnShare.setTitle("SHARE".localized, for: .normal)
    ...
    {
//        let decodeResults = Singleton.shared.dictProfile
//        print(decodeResults)
//        var strName = String()
...
//    {
//        let profile = Singleton.shared.dictProfile
