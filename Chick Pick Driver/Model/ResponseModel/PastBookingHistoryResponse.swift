...
class PastBookingHistoryResponse : NSObject, NSCoding{
	...
	func toDictionary() -> [String:Any]
	{
        ...
        if customerFirstName != nil{
        	dictionary["customer_first_name"] = customerFirstName
        }
        if customerId != nil{
        	dictionary["customer_id"] = customerId
        }
        if customerLastName != nil{
        	dictionary["customer_last_name"] = customerLastName
        }
        if discount != nil{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
		...
		customerFirstName = aDecoder.decodeObject(forKey: "customer_first_name") as? String
		customerId = aDecoder.decodeObject(forKey: "customer_id") as? String
		customerLastName = aDecoder.decodeObject(forKey: "customer_last_name") as? String
    ...
    */
    func encode(with aCoder: NSCoder)
	{
		...
		if customerFirstName != nil{
			aCoder.encode(customerFirstName, forKey: "customer_first_name")
		}
		if customerId != nil{
			aCoder.encode(customerId, forKey: "customer_id")
		}
		if customerLastName != nil{
			aCoder.encode(customerLastName, forKey: "customer_last_name")
		}
		if discount != nil{
