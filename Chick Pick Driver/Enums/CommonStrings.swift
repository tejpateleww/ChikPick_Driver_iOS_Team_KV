...
let passwordValidErrorString = "Password must be have minimum 6 character"
let confirmPasswordValidErrorString = "Confirm password must be have minimum 6 character"
